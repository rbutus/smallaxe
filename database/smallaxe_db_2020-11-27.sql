...
INSERT INTO `menu_categories` VALUES (1,'Taco Walk on The Wild Side!',1,1,'2020-11-25 16:18:14','2020-11-25 16:18:14'),(2,'Vladimir Poutines...',1,1,'2020-11-25 16:18:32','2020-11-25 16:18:32'),(3,'Eat Your Vegetables!',1,1,'2020-11-25 16:18:41','2020-11-25 16:18:41'),(4,'Fan Favourites!',1,1,'2020-11-25 16:18:47','2020-11-25 16:18:47'),(5,'Burgers She Wrote...',1,1,'2020-11-25 16:18:54','2020-11-25 16:18:54'),(6,'I Like Big Bowls! (And I Cannot Lie)',1,1,'2020-11-25 16:19:01','2020-11-25 16:19:02'),(7,'none',1,1,'2020-11-25 16:19:31','2020-11-25 16:19:31'),(8,'Brews Brothers!',1,1,'2020-11-28 12:27:54','2020-11-28 12:27:54'),(9,'Ciders & Basic B\'s...',1,1,'2020-11-28 12:28:19','2020-11-28 12:28:19'),(10,'On The Wagon...',1,1,'2020-11-28 12:28:31','2020-11-28 12:28:31'),(11,'Something to Wine About',1,1,'2020-11-28 12:28:46','2020-11-28 12:28:46'),(12,'OG Cocktails...',1,1,'2020-11-28 12:28:57','2020-11-28 12:28:57');
/*!40000 ALTER TABLE `menu_categories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `menu_categories_menu_drinks__menu_drinks_menu_categories`
--

DROP TABLE IF EXISTS `menu_categories_menu_drinks__menu_drinks_menu_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `menu_categories_menu_drinks__menu_drinks_menu_categories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `menu-drink_id` int(11) DEFAULT NULL,
  `menu-category_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `menu_categories_menu_drinks__menu_drinks_menu_categories`
--

LOCK TABLES `menu_categories_menu_drinks__menu_drinks_menu_categories` WRITE;
/*!40000 ALTER TABLE `menu_categories_menu_drinks__menu_drinks_menu_categories` DISABLE KEYS */;
INSERT INTO `menu_categories_menu_drinks__menu_drinks_menu_categories` VALUES (1,1,8),(2,2,8),(3,3,8),(4,4,8),(5,6,9),(6,7,9),(8,13,12),(9,14,12),(10,16,12),(11,17,12),(12,18,12),(13,19,12),(14,20,12),(15,27,12),(16,28,12),(17,29,12),(18,30,12),(19,31,12),(20,32,12),(21,21,10),(22,22,10),(23,23,10),(24,24,10),(25,25,10),(26,26,10),(27,8,11),(28,9,11),(29,10,11);
/*!40000 ALTER TABLE `menu_categories_menu_drinks__menu_drinks_menu_categories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `menu_categories_menu_main_items__menu_main_items_menu_categories`
--

DROP TABLE IF EXISTS `menu_categories_menu_main_items__menu_main_items_menu_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `menu_categories_menu_main_items__menu_main_items_menu_categories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `menu_categories_menu_main_items__menu_main_items_menu_categories`
--

LOCK TABLES `menu_categories_menu_main_items__menu_main_items_menu_categories` WRITE;
/*!40000 ALTER TABLE `menu_categories_menu_main_items__menu_main_items_menu_categories` DISABLE KEYS */;
INSERT INTO `menu_categories_menu_main_items__menu_main_items_menu_categories` VALUES (1,28,4),(2,14,5),(3,10,3),(4,31,5),(5,23,4),(6,3,1),(7,13,5),(8,30,5),(9,24,7),(10,6,2),(11,25,7),(12,5,2),(13,15,5),(14,2,1),(15,29,4),(16,17,5),(17,4,1),(18,7,2),(19,8,3),(20,21,5),(21,19,5),(22,18,5),(23,1,1),(24,22,5),(25,33,5),(26,11,3),(27,12,5),(28,9,3),(29,20,5),(30,16,5),(31,26,7),(32,32,5),(33,27,2);
/*!40000 ALTER TABLE `menu_categories_menu_main_items__menu_main_items_menu_categories` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `menu_drinks` VALUES (1,'Brews Brothers','Havin\' A Domestic','$5','Alexander Keiths, Budweiser, Bud Light, OK Springs 1516, Pabst Blue Ribbon',2,1,'2020-10-10 21:34:44','2020-11-28 12:32:25',NULL,NULL),(2,'Brews Brothers','Little More Flava Flav','$6','Coors Banquet, Rickard\'s Radler, Red Racer IPA, Mt. Begbie Nasty Habit, 33 Acres of Sunshine French Blanche, Strange Fellows Talisman Pale Ale',2,1,'2020-10-10 21:36:02','2020-11-28 12:32:35',NULL,NULL),(3,'Brews Brothers','Craft Beer',NULL,'Ask Your Server About Our Rotating Craft Beers',2,1,'2020-10-10 21:37:11','2020-11-28 12:32:42',NULL,NULL),(4,'Brews Brothers','Draft Beer','$7 pints | $22 pitchers','Ask Your Server About Our Rotating Draft Beers',2,1,'2020-10-10 21:38:58','2020-11-28 12:32:50',NULL,NULL),(6,'Ciders & Basic B\'s...','Strongbow','$7',NULL,2,1,'2020-10-10 21:40:33','2020-11-28 12:32:59',NULL,NULL),(7,'Ciders & Basic B\'s...','Wize Vodka Sodas','$6.50','Root Beer & Cream Soda',2,1,'2020-10-10 21:41:39','2020-11-28 12:33:05',NULL,NULL),(8,'Something to Wine About','Reds','6 oz. $7 | 9 oz. $9','La Posada Organic Tempranillo, Jackson Triggs Malbec, Copper Moon Shiraz',2,1,'2020-10-10 21:43:43','2020-11-28 12:35:35',NULL,NULL),(9,'Something to Wine About','Whites','6 oz. $7 | 9 oz. $9','Peller Estates Pinot Grigio, Jackson Triggs Sauvignon Blanc',2,1,'2020-10-10 21:44:16','2020-11-28 12:35:40',NULL,NULL),(10,'Something to Wine About','Rosé','6 oz. $7 | 9 oz. $9','Ask Your Server About Our Rotating Feature',2,1,'2020-10-10 21:45:21','2020-11-28 12:35:45',NULL,NULL),(13,'OG Cocktails','Jalapeño Bidness Margarita (1.5oz)','$9','A Small Axe Classic with Triple Sec, Tequila,\nFresh Jalapeño, Lime, and Cucumber',2,1,'2020-10-10 21:48:38','2020-11-28 12:33:21',NULL,NULL),(14,'OG Cocktails','The Dude (1.5oz)','$8','\nA White Russian with a Caffeinated Kick... Iced\nCoffee, Kahlúa, Vodka, & Dairy Free Cream...\nServed Over Ice... The Dude Abides!',2,1,'2020-10-10 21:50:11','2020-11-28 12:33:29',NULL,NULL),(16,'OG Cocktails','Edward Caesar Hands (1oz)','$7.5','\nClassic Ceasar Served With House Pickled\nVegetables',2,1,'2020-10-10 21:52:46','2020-11-28 12:33:35',NULL,NULL),(17,'OG Cocktails','The Drunk Republican (1oz)','$7','\nAn Arnold Palmer, but with Booze... Half\nLemonade, Half Iced Tea, & Vodka... \'Cause Booze Makes Everything Better!',2,1,'2020-10-10 21:54:19','2020-11-28 12:33:42',NULL,NULL),(18,'OG Cocktails','Strawberry Feels Forever (1oz)','$7','\nLemonade, Vodka, and House Strawberry Purée',2,1,'2020-10-10 21:55:26','2020-11-28 12:33:51',NULL,NULL),(19,'OG Cocktails','Sangre-Ahhhhh','$6','Summertime Bliss in a Glass!',2,1,'2020-10-10 21:57:05','2020-11-28 12:33:57',NULL,NULL),(20,'OG Cocktails','Bye Felicia!','$3.5','Our Last Call Special - A Well Shot for $3.5, But You Gots to Go After!',2,1,'2020-10-10 21:58:08','2020-11-28 12:34:02',NULL,NULL),(21,'On The Wagon...','Coffee','$2','Freshly Brewed Shuswap Coffee Company Drip',2,1,'2020-10-10 21:59:05','2020-11-28 12:34:54',NULL,NULL),(22,'On The Wagon...','Tea','$2','Twining\'s Earl Grey, Pure Peppermint, Pure Chamomile, Pure Rooibos Red, Honeybush Mandarin-Orange',2,1,'2020-10-10 22:02:08','2020-11-28 12:35:05',NULL,NULL),(23,'On The Wagon...','Iced Coffee','$3','House Iced Shuswap Coffee Company Drip',2,1,'2020-10-10 22:03:34','2020-11-28 12:35:11',NULL,NULL),(24,'On The Wagon...','Lemonade & Juice','$3','Lemonade, Orange Juice, Pineapple Juice, Cranberry Juice',2,1,'2020-10-10 22:04:32','2020-11-28 12:35:16',NULL,NULL),(25,'On The Wagon...','Shirley Temple','$4','7up, Orange & Pineapple Juice, Grenadine, & Topped with a Maraschino Cherry',2,1,'2020-10-10 22:05:09','2020-11-28 12:35:22',NULL,NULL),(26,'On The Wagon...','Soda-Pop','$2.5','Pepsi, Diet Pepsi, Dr. Pepper, Root Beer, 7up, Ginger Ale, Iced Tea',2,1,'2020-10-10 22:06:23','2020-11-28 12:35:28',NULL,NULL),(27,'OG Cocktails','Pulp Fiction (1.5oz)','$9','Blood Orange Gin with Muddled Citrus, Cherry and the Perfect Temperature Water.',2,1,'2020-11-24 06:25:22','2020-11-28 12:34:08',NULL,NULL),(28,'OG Cocktails','Whiskey a Go-Go (1oz)','$8','All the venues might be closed but we can give you a party in your mouth with this Whiskey Sour.',2,1,'2020-11-24 06:27:51','2020-11-28 12:34:24',NULL,NULL),(29,'OG Cocktails','Berry Nice!!! (1oz)','$8','You have to say it in a Borat voice. Strawberry and Raspberry infused Gin Sour with fresh Strawberry Puree.',2,1,'2020-11-24 06:29:57','2020-11-28 12:34:29',NULL,NULL),(30,'OG Cocktails','The Jessie Spano (2oz)','$10','Espresso Martini - Vodka, Kahlua and an Espresso Shot! So tasty you\'ll be screaming <b>\"I\'M SO EXCITED!\"</b>',2,1,'2020-11-24 06:35:47','2020-11-28 12:34:35',NULL,NULL),(31,'OG Cocktails','Toddy 2 Hotty (1oz)','$8','Our Hot Toddy! Crafted to keep you warm and toasty on these cold days with Whiskey, Honey, Lemon, Cinnamon and Spices.',2,1,'2020-11-24 06:39:13','2020-11-28 12:34:41',NULL,NULL),(32,'OG Cocktails','Sailor\'s Cider (1oz)','$8','Sailor Jerry\'s Spiced Rum and our house made Apple Cider. It\'ll keep you warm all the way down to Davy Jones Locker, <b> Yarrrrr!</b>',2,1,'2020-11-24 06:42:15','2020-11-28 12:34:47',NULL,NULL);
...
INSERT INTO `menu_main_items` VALUES (1,'Pull My Pork Tacos','(Gluten Free) Pulled Pork, Maple Lime BBQ, Mango Jalapeño Salsa, Avocado, Chipotle Aioli, Pickled Red Onions, & Cabbage','2 for $9',2,1,'2020-10-10 21:01:43','2020-11-25 16:29:36','Taco Walk on the Wild Side',1),(2,'Jack My Fruit Tacos','(Gluten Free/Vegan) Jackfruit, Maple Lime BBQ, Mango Jalapeño Salsa, Avocado, Chipotle Aioli, Pickled Red Onions, & Cabbage','2 for $9',2,1,'2020-10-10 21:02:44','2020-11-25 16:28:03','Taco Walk on the Wild Side',1),(3,'Black Eyed Chick Peas Tacos','(Gluten Free/Vegan) Small Axe Cajun Spiced Chickpeas, House Tomato Salsa, Avocado, Cilantro Lime Crema, Pickled Red Onions, & Cabbage','2 for $9',2,1,'2020-10-10 21:03:32','2020-11-25 16:25:25','Taco Walk on the Wild Side',1),(4,'Le Prawn James Tacos','Coconut Crusted Prawns, Mango Jalapeño Salsa, Avocado, Chipotle Aioli, Pickled Red Onions, & Cabbage','2 for $9',2,1,'2020-10-10 21:04:13','2020-11-25 16:28:38','Taco Walk on the Wild Side',1),(5,'Hunter Poutine','House Gravy, Quebec Cheese Curds, & Kennebec Fries','$10',2,1,'2020-10-10 21:05:06','2020-11-25 16:27:47','Vladimir Poutines',1),(6,'Gatherer Poutine','(Gluten Free/Vegan) House Chick Pea Gravy, Vegan Smoked Gouda, & Kennebec Fries','$10',2,1,'2020-10-10 21:06:16','2020-11-25 16:27:27','Vladimir Poutines',1),(7,'Mexi-Can Tots','(Gluten Free/Vegan) Roasted Corn Salsa, Cilantro Lime Crema, Chipotle Aioli, Tomato, Green Onions, Pickled Red Onions, & Blackened Tots','$10',2,1,'2020-10-10 21:07:03','2020-11-25 16:28:48','Vladimir Poutines',1),(8,'Nacho Average Rice Bowl','(Vegan/Gluten Free) Cajun Rice, Avocado, Hummus, Spinach, Roasted Corn & Black Bean Salsa, Pickled Cabbage, Tomato, Peppers, Corn Chips, Green Onion, Cilantro Lime Crema, & Chipotle Dressing','$15',2,1,'2020-10-10 21:08:38','2020-11-25 16:28:58','Eat Your Vegetables!',1),(9,'The Bruce Moose Buddha Bowl','(Gluten Free) Crispy Chickpeas, Coconut Brown Rice, Avocado, Roasted Garlic Hummus, Spinach, Beets, Hemp Hearts, Pumpkin Seeds, Apples, & Green Goddess Dressing\n(Vegan Option Available)','$15',2,1,'2020-10-10 21:10:08','2020-11-25 16:30:15','Eat Your Vegetables!',1),(10,'Axe Salad','(Gluten Free) Feta, Cranberries, Toasted Walnut, Apples, Mixed Greens, & Honey Dijon Vinaigrette \n(Vegan Option Available)','sm $8 | lg $12',2,1,'2020-10-10 21:14:30','2020-11-25 16:25:56','Eat Your Vegetables!',1),(11,'Thai One On Salad','(Gluten Free/Vegan) Carrot, Peppers, Cucumbers, Onions, Mango Jalapeño Salsa, Cabbage, Peanuts, Vermicelli Noodles, & Thai Peanut Dressing\n(Add Coconut Crusted Prawns for $2 each)','sm $10 | lg $15',2,1,'2020-10-10 21:15:54','2020-11-25 16:30:01','Eat Your Vegetables!',1),(12,'The Axe Burger','Bacon, Smoked Cheddar, Garlic Aioli, Lettuce, Tomato, Onions, & Pickles','$16.50',2,1,'2020-10-10 21:17:09','2020-11-25 16:30:07','Burgers She Wrote',1),(13,'Canadian \"EH\" Burger','Poutine Burger, Quebec Cheese Curds, Fries, House Gravy, Onions, & Garlic Aioli on a Brioche Bun (Vegan Option Available)','$16.50',2,1,'2020-10-10 21:18:28','2020-11-25 16:25:37','Burgers She Wrote',1),(14,'\'Merica Classic Burger','Make America Tasty Again!\nCaramelized Onions, American Cheddar,, Mayo, Mustard, Lettuce, Tomato, Onion, & Pickles','$16.50',2,1,'2020-10-10 21:20:04','2020-11-25 16:26:00','Burgers She Wrote',1),(15,'Into The Great Beyond Burger','Beyond Meat Burger, Daiya Cheddar, Vegan Garlic Mayo, Yellow Mustard, Lettuce, Tomato, Onions, & Pickles\n(Vegan Option Available)','$16.50',2,1,'2020-10-10 21:23:00','2020-11-25 16:27:55','Burgers She Wrote',1),(16,'The Greta Thunberg Burger','(Vegan) Lentil, Rice, & Bean Burger, Ginger Peanut Sauce, Carrot, Cucumber, Pickled Cabbage, & Onion on a Whole Wheat Bun \n(No Gluten Free Option Available)','$16.50',2,1,'2020-10-10 21:24:24','2020-11-25 16:30:29','Burgers She Wrote',1),(17,'Krabby Patty Po\' Boy Burger','House Made Crab Cake, Creamy Slaw, Cajun Remoulade, Lettuce, Tomato, Onions, & Pickles - Sponge Bob Approved\n(No Gluten Free Option Available)','$16.50',2,1,'2020-10-10 21:25:15','2020-11-25 16:28:24','Burgers She Wrote',1),(18,'Porky\'s Sandwich ','Maple Bourbon BBQ Pulled Pork, Creamy Slaw, Chipotle Aioli, Smoked Cheddar, Pickled Onions, & Topped with Corn Chips','$16.50',2,1,'2020-10-10 21:26:24','2020-11-25 16:29:27','Burgers She Wrote',1),(19,'Porky\'s Revenge Sandwich','Maple Bourbon BBQ Pulled Jackfruit, Creamy Slaw, Chipotle Aioli, Pickled Onions, & Topped with Corn Chips\n(Vegan Option Available When Requested)','$16.50',2,1,'2020-10-10 21:27:01','2020-11-25 16:29:15','Burgers She Wrote',1),(20,'The Crispy Kenny Rogers Burger','Crispy Fried Chicken Breast, Garlic Aioli, Lettuce, Tomato, Onion, & Pickles \n(No Gluten Free Option Available)','$16.50',2,1,'2020-10-10 21:27:43','2020-11-25 16:30:22','Burgers She Wrote',1),(21,'Not Even If There\'s A Fire! Burger','A Crispy Kenny Rogers With Added Heat! Done Nashville Hot Chicken Style with Sour Cream & Dill Ranch, Pickled Cabbage, Lettuce, Tomato, Onion, & Pickles\n(No Gluten Free Option Available)','$16.50',2,1,'2020-10-10 21:28:51','2020-11-25 16:29:05','Burgers She Wrote',1),(22,'Roadhouse! Burger','Swayze Yourself With a Roadhouse Kick to Your Tastebuds!\n6 oz. Ground Chuck Patty, House Smoked Pulled Pork, Deep Fried Mac & Cheese Patty, Cheese Curds, Fries, House Gravy, Chipotle Aioli, Lettuce, Tomato, & Onions\n(Vegetarian Option Available)\n(No Gluten Free Option Available)','$22',2,1,'2020-10-10 21:30:42','2020-11-25 16:29:42','Burgers She Wrote',1),(23,'Big Ole Yorkie','Braised Beef, Garlic Mashed Potatoes, House Gravy, & Horseradish Crema in a Giant Yorkshire Pudding Bowl','$18',2,1,'2020-10-10 21:31:48','2020-11-25 16:25:50','Fan Favourite!',1),(24,'Feature Dessert',NULL,'$7',2,1,'2020-10-10 21:32:26','2020-11-25 16:27:18','Sweet Tooth',NULL),(25,'Gluten Free Dessert',NULL,'$8',2,1,'2020-10-10 21:32:52','2020-11-25 16:27:40','Sweet Tooth',NULL),(26,'Vegan Dessert',NULL,'$8',2,1,'2020-10-10 21:33:03','2020-11-25 16:30:42','Sweet Tooth',NULL),(27,'X-Treme Poutine!','<b>THIS POUTINE IS A REAL MEAL!</b> House-cut Fries, Country Sausage Gravy, Fried Chicken, Egg, Bacon, Quebec Cheese Curds.','$16',2,1,'2020-11-24 00:39:05','2020-11-25 16:30:57','Vladimir Poutines',1),(28,'\"Sweet Dreams Are Made of Cheese\"','<b>Who am I to dis a Brie?</b><br> Our Mac & Cheese topped with Cheddar, Parmesian & Cornbread Crumble. Baked and served with Salad and garlic Bread.','$18',2,1,'2020-11-24 05:29:50','2020-11-25 16:24:04','Fan Favorite\'s!',1),(29,'Juan in a Million Nachos','<b>(Gluten Free)</b> House Cooked Tortilla Chips, 3 Cheese Blend, Feta, Roasted Corn, Deep Fried Jalapeños, Chipotle Black Beans, Pickled Cabbage, Diced Tomatoes, Green Onions and Cilantro-Lime Crema Drizzle. (Sorry not available for take-out!)\n<br>\n<b>Add Salsa or Sour Cream for $2/Substitute Vegan Cheese for $4<b/>','$20',2,1,'2020-11-24 05:39:07','2020-11-25 16:28:16','Fan Favorite\'s!',1),(30,'Curious Cowboy Burger','6oz Beef Burger, Bacon, Pulled Pork, Onion Rings, Slaw and Chippy Aioli.','$18.50',2,1,'2020-11-24 05:44:07','2020-11-25 16:26:16','Burgers She Wrote',1),(31,'Bi-Curious Cowboy Burger','Add an extra 6oz Homemade Beef Burger to the Curious Cowboy','$23',2,1,'2020-11-24 05:54:06','2020-11-25 16:25:53','Burgers She Wrote',1),(32,'What The Cluck?! Burger','Crispy Chicken Breast, Bacon, Cornbread, American Cheddar, Deep Fried Jalapeños, Sausage Gravy, Garlic Aioli, Lettuce, Tomato and Onion. ','$20.50',2,1,'2020-11-24 05:57:28','2020-11-25 16:30:50','Burgers She Wrote',1),(33,'Roundhouse Kick To The FACE! Burger','<b>Our Biggest Burger Yet!</b><br>\n6oz Beef Burger, Fried Chicken Breast Topped in Hot Sauce, Bacon, Blue Cheese Dressing, Onion Rings, Deep Fried Pickles, Lettuce, Tomato and Onion.','$25',2,1,'2020-11-24 06:02:28','2020-11-25 16:29:52','Burgers She Wrote',1);
...
INSERT INTO `menu_main_titles` VALUES (1,'Main Menu','Weekdays:  10:30am - close<br>\nWeekends:  1pm - close',1,2,'2020-11-18 13:26:51','2020-11-24 06:08:35',1);
/*!40000 ALTER TABLE `menu_main_titles` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `menu_weekday`
--

DROP TABLE IF EXISTS `menu_weekday`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `menu_weekday` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `description` longtext DEFAULT NULL,
  `category` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `menu_weekday`
--

LOCK TABLES `menu_weekday` WRITE;
/*!40000 ALTER TABLE `menu_weekday` DISABLE KEYS */;
/*!40000 ALTER TABLE `menu_weekday` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `menu_weekend`
--

DROP TABLE IF EXISTS `menu_weekend`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `menu_weekend` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `category` varchar(255) DEFAULT NULL,
  `description` longtext DEFAULT NULL,
...
--
-- Dumping data for table `menu_weekend`
--

LOCK TABLES `menu_weekend` WRITE;
/*!40000 ALTER TABLE `menu_weekend` DISABLE KEYS */;
/*!40000 ALTER TABLE `menu_weekend` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `menu_weekend_breakfast_items` VALUES (1,'The Bernie Mac Benny','Weekend At Benny\'s!','Bacon, Poached Egg, Fresh Tomato, \nCrispy Jalapeños, & Hollandaise on\nDeep Fried Mac & Cheese Patties\n(Sub Veggie Bacon for $1)','Half Order $12.5 | Full Order $16',2,2,'2020-10-10 22:10:58','2020-11-24 20:50:03',NULL,NULL),(2,'Benny Crabitz','Weekend At Benny\'s!','House Crab Cake, Poached Egg, Fried Capers, Fresh Dill, Lemon Zest, & Hollandaise on an English Muffin \n(Sorry, No Half Orders Available at this Time)\n','$16',2,2,'2020-10-10 22:12:28','2020-11-24 20:47:07',NULL,NULL),(3,'PP For My Corn(Holio)Bread Benny','Weekend At Benny\'s!','House Smoked Pork, Poached Egg, Maple Bourbon BBQ, Grilled Red Peppers, Chipotle Aioli Drizzle, Green Onions, & Hollandaise on Cornbread\n(Sub Pulled Jackfruit to Make It Vegetarian)\n\n','Half Order $12.5 | Full Order $16',2,2,'2020-10-10 22:15:24','2020-11-24 20:51:34',NULL,NULL),(4,'The Mother Clucker Benny','Weekend At Benny\'s!','Fried Chicken, Poached Egg, Peppered Bacon Bits, Maple Syrup Drizzle, & Country Gravy on Cornbread\n','Half Order $12.5 | Full Order $16',2,2,'2020-10-10 22:16:36','2020-11-24 20:52:08',NULL,NULL),(5,'If Natalie Portman Were A Benny...','Weekend At Benny\'s!','(Vegan)\nRice, Lentil & Bean Cake, Avocado, Tomato, Roasted Corn Salsa, Pickled Red Onion, & Vegan Garlic Aioli Drizzle on an English Muffin.\n','Half Order $12.5 | Full Order $16',2,2,'2020-10-10 22:19:14','2020-11-24 20:47:44',NULL,NULL),(6,'Spiked Coffee','Brunch Drinks','(1 oz.)\nFresh Brewed Shuswap Coffee Company Drip with Bailey\'s, Amaretto, Kahlua, Frangelico, Jameson, or Creme de Menthe','$4.75',2,2,'2020-10-10 22:20:46','2020-10-10 22:20:46',NULL,NULL),(7,'Screwdrivers','Brunch Drinks','Orange Juice with Vodka','1oz. $5.25 | 2oz. $7.25',2,2,'2020-10-10 22:21:39','2020-10-10 22:21:40',NULL,NULL),(8,'Double Caesars','Brunch Drinks','Classic Caesar Served with House Pickled Vegetables','$9',2,2,'2020-10-10 22:22:18','2020-10-10 22:22:19',NULL,NULL),(9,'The Dude','Brunch Drinks','(1.5 oz.)\nA White Russian with a Caffeinated Kick! Iced Coffee, Vodka, Kahlua, and Dairy Free Cream','$7.5',2,2,'2020-10-10 22:23:21','2020-10-10 22:23:21',NULL,NULL),(10,'The Axe Burger','Burgers She Wrote','Bacon, Smoked Cheddar, Garlic Aioli, Lettuce, Tomato, Onion, & Pickles','$16.50',2,2,'2020-10-10 22:25:09','2020-11-24 20:49:04',NULL,NULL),(11,'Canadian \"EH\" Burger','Burgers She Wrote','Poutine Burger, Quebec Cheese Curds, Fries, House Gravy, Onions, and  Garlic Aioli on a Brioche Bun\n(Vegan Option Available)\n','$16.50',2,2,'2020-10-10 22:26:38','2020-11-24 20:47:23',NULL,NULL),(12,'\'Merica Classic Burger','Burgers She Wrote','Make America Tasty Again!\nCaramelized Onions, American Cheddar, Pickles, Mayo, Mustard, Lettuce, Tomato, & Onion\n','$16.50',2,2,'2020-10-10 22:27:12','2020-11-24 20:46:22',NULL,NULL),(13,'Into The Great Beyond Burger','Burgers She Wrote','Beyond Meat Burger, Daiya Cheddar, Vegan Mayo, Yellow Mustard, Lettuce, Tomato, Onion, & Pickles\n(Vegan Option Available)','$16.50',2,2,'2020-10-10 22:28:19','2020-11-24 20:47:54',NULL,NULL),(14,'The Crispy Kenny Rogers Burger','Burgers She Wrote','Crispy Fried Chicken Breast, Garlic Aioli, Lettuce, Tomato, Onion, & Pickles\n(No Gluten Free Option Available)','$16.50',2,2,'2020-10-10 22:28:55','2020-11-24 20:50:19',NULL,NULL),(15,'Roadhouse! Burger','Burgers She Wrote','Swayze Yourself With A Kick To The Tastebuds! \n6oz. Ground Chuck Patty, House Smoked Pulled Pork, Deep Fried Mac & Cheese Patty, Cheese Curds, Fries, House Gravy, Chipotle Aioli, Lettuce, Tomato, & Onion.\n(Vegetarian Option Available)\n(No Gluten Free Option Available)\n','$22',2,2,'2020-10-10 22:30:57','2020-11-24 20:48:52',NULL,NULL),(16,'Axe Salad','Eat Your Vegetables!','(Gluten Free)\nFeta, Cranberries, Toasted Walnut, Apple, Mixed Greens, & Balsamic Dijon Vinaigrette\n(Vegan Option Available)\n','sm $8 | lg $12',2,2,'2020-10-10 22:32:44','2020-10-10 22:32:44',NULL,NULL),(17,'Thai One On Salad','Eat Your Vegetables!','(Gluten Free/Vegan) \nCarrot, Peppers, Onion, Mango Jalapeno Salsa, Cabbage, Peanuts, Vermicelli Noodles, & \nThai Peanut Dressing\n','sm $10 | lg $15',2,2,'2020-10-10 22:33:20','2020-10-10 22:33:20',NULL,NULL),(18,'Hunter Poutine','Vladimir Poutines','House Gravy, Quebec Cheese Curds, & Kennebec Fries','$10',2,2,'2020-10-10 22:34:01','2020-10-10 22:34:19',NULL,NULL),(19,'Gatherer Poutine','Vladimir Poutines','(Gluten free/Vegan)\nHouse Chickpea Gravy, Vegan Smoked Gouda, Kennebec Fries\n','$10',2,2,'2020-10-10 22:34:56','2020-10-10 22:34:56',NULL,NULL);
...
INSERT INTO `menu_weekend_breakfast_titles` VALUES (1,'Weekend Breakfast Menu','Saturday:  9am - 1pm<br>\nSunday: 9am - 1pm',1,2,'2020-11-23 14:05:42','2020-11-24 06:10:11',1);
...
-- Dump completed on 2020-11-27 21:56:13
